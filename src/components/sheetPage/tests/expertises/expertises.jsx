...
function SingularExpertise({ expertiseName, roll, expertise }) {
    ...
    const rollExp = () => {
        ...
        if (agilidade.find((e) => e === expertiseName))
            roll(
                expertiseName,
                parseInt(characters[currentCharacter].agility),
                bonus
            );
        else if (intelecto.find((e) => e === expertiseName))
            roll(
                expertiseName,
                parseInt(characters[currentCharacter].intelect),
                bonus
            );
        else if (vigor.find((e) => e === expertiseName))
            roll(
                expertiseName,
                parseInt(characters[currentCharacter].vigor),
                bonus
            );
        else if (presenca.find((e) => e === expertiseName))
            roll(
                expertiseName,
                parseInt(characters[currentCharacter].presence),
                bonus
            );
        else if (forca.find((e) => e === expertiseName))
            roll(
                expertiseName,
                parseInt(characters[currentCharacter].strength),
                bonus
            );
    };
    ...
    return (
        <div className="boxExp">
            ...
            <select
                ...
                value={characters[currentCharacter][expertise]}
            >
...
export default function Expertises({ expertises, roll }) {
    var componentsArr = [];
